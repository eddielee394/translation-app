                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            @if($row->display_name == 'Attachments')
                                                <a href="{{route('file_download', $data->{$row->field})}}">{{ $data->{$row->field} }}</a>
                                            @else                 
                                                {{ $data->{$row->field} }}
                                            @endif
                                        @endif
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        @endif
                                        <a href="{{ route('voyager.'.$dataType->slug.'.copy', ['id' => $data->id, 'slug' => $dataType->slug]) }}" title="Copy" class="btn-sm btn-info pull-right copy">
                                            <i class="voyager-harddrive"></i> <span class="hidden-xs hidden-sm">Copy</span>
                                        </a>
