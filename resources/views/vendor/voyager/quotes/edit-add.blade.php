...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            //var pel = ;
            //console.log(pel);
            var attachementsList = $('input[name="attachments"]').val();
            var attachements = attachementsList.split(',');
            var attachementsLinks = '';

            $.each(attachements, function( index, value ) {
                attachementsLinks = attachementsLinks + '<a href="/storage/quote-attachements/' + value + '">' + value + '</a><br/>';

            });
                          
            $("<p>"+attachementsLinks+"</p>").insertAfter($('input[name="attachments"]').parent(0));
