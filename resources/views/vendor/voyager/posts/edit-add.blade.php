                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        @foreach($dataTypeRows as $row)
                            <!--- Only load the locale field -->
                                @if($row->field == 'id_lang')
                                    <div id="form-group-{{ strtolower($row->field) }}"
                                         class="form-group @if($row->type == 'hidden') hidden @endif">
